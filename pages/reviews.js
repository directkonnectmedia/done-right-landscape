...
export default function ReviewsPage() {
  return (
    <>
      <Head>
        <title>Reviews — Done Right Landscaping</title>
        <meta property="og:title" content="Reviews — Done Right Landscaping" />
        <meta
          name="description"
          content="See what West Valley homeowners are saying about Done Right Landscaping."
        />
      </Head>
      <div className="rv-page">
        ...
        <section className="rv-hero">
          <div className="rv-hero-inner">
            <span className="rv-eyebrow">WHAT CLIENTS SAY</span>
            <h1 className="rv-title">Reviews &amp; Testimonials</h1>
            <p className="rv-subtitle">
              Real feedback from real West Valley homeowners. We take every project personally —
              and our clients notice.
            </p>
            <div className="rv-summary">
              <Stars size={22} />
              <span className="rv-summary-score">5.0 average</span>
              <span className="rv-summary-dot">·</span>
        ...
        <section className="rv-grid-section">
          ...
          >
            {REVIEWS.map((r) => (
              <motion.article key={r.name} className="rv-card" variants={cardVariant}>
                <div className="rv-card-top">
                  <Stars />
                  <svg className="rv-quote-mark" width="34" height="34" viewBox="0 0 24 24" fill="var(--color-accent)" opacity="0.18" aria-hidden="true">
